...
FILE_REVIEW_PROMPT = ChatPromptTemplate.from_messages(
    [
        SystemMessagePromptTemplate.from_template(
            """
        You are a seasoned code reviewer who's good at reviewing the file's contents and providing detailed, constructive feedback on the following aspects in the below foemat:
